...
//   // Fetch ABI, bytecode, and deployed contract address (if available)
//   useEffect(() => {
//     async function fetchAbiAndBytecode() {
//       try {
//         const abiResponse = await fetch("/contractABI.json");
...
//       if (response.ok) {
//         setIsPasscodeRequested(true); // Allow passcode input to be editable
//         setLoginError("Passcode requested. Please check your email.");
//       } else {
//         setLoginError("Failed to request passcode. Please try again.");
//         setTimeout(() => {
//           setLoginError(null);
...
//                         onChange={(e) => setPassword(e.target.value)}
//                         placeholder="Passcode"
//                         className="pl-24 rounded-xl py-9 bg-[#D9D9D9] text-black w-full ${!isPasscodeRequested ? '<p>Hello</p> cursor-not-allowed' : 'cursor-auto'}}"
//                         readOnly={!isPasscodeRequested} // Conditionally set the readOnly attribute
//                       />
//                       <Image
//                         src={"/lock.png"}
//                         alt=""
